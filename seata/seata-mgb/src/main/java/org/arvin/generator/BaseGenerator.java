...
//                .addTablePrefix("t_")
    ...
    protected static GlobalConfig.Builder globalConfig(){
        return new GlobalConfig.Builder()
                .outputDir("E:\\others project\\seata\\seata-mgb\\src\\main\\java")
                .author("arvin")
    ...
    protected static PackageConfig.Builder packageConfig(){
        return new PackageConfig.Builder()
                .parent("org.arvin")
                .pathInfo(Collections.singletonMap(OutputFile.xml,"E:\\others project\\seata\\seata-mgb\\src\\main\\resources\\mapper"))
                .entity("pojo")
                .service("service")
